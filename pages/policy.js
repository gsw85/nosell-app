  ...
  return (
    <div className="flex flex-col space-y-5 text-gray-500">
      ...
      <div className="text-sm">
        Thank you for purchasing our digital product. We hope you are satisfied
        with your purchase, but please be aware that we do not offer any returns
        or refunds for digital products.
      </div>
      <div className="text-sm">
      ...
      <div className="text-sm">
        ...
        contact us within 7 days of purchase, and we will do our best to assist
        you.
      </div>
      <div className="text-sm">
